...
// Подсветить тег
javascript:(function(){
    custom_select_tag = prompt('Что подсветить?(Выборка jq)','a');
...
javascript: (function() { var style = document.getElementById('bstrongemhighlight'); if (style) { style.remove(); } else { var bStngEm = document.createElement('style');
