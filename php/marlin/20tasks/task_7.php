...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row js-list-filter" id="js-contacts">
		...
		$users = [
				[
						"avatarSrc" => "img/demo/avatars/avatar-b.png",
						"name"      => "1Oliver Kopyov",
				...
				[
						"avatarSrc" => "img/demo/avatars/avatar-c.png",
						"name"      => "2Oliver Kopyov",
						"position"  => "IT Director, Gotbootstrap Inc.",
						"phone"     => "+1 317-456-2564",
						"email"     => "oliver.kopyov@smartadminwebapp.com",
				...
				[
						"avatarSrc" => "img/demo/avatars/avatar-d.png",
						"name"      => "3Oliver Kopyov",
						"position"  => "IT Director, Gotbootstrap Inc.",
						"phone"     => "+1 317-456-2564",
						"email"     => "oliver.kopyov@smartadminwebapp.com",
					...
					<div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
						<div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo $user["avatarSrc"]; ?>'); background-size: cover;"></span>
                                </span>
