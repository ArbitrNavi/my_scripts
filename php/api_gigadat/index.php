		...
		<div class="col-10 col-lg-4 col-sm-8">
			<form action="login" method="post" id="form_gigadat">
				...
				<div class="mb-3">
					...
					<input type="number" class="form-control" id="amount" name="amount" step="" aria-describedby="emailHelp" min="5" max="3000" onchange="document.querySelector('#balance').innerHTML = this.value" required>
				</div>

				<!--                <a class="link-secondary" href="#">У меня есть код партнера</a>-->
				<!--                <a class="link-secondary" href="#">У меня есть код партнера</a>--><br>
				<br>
