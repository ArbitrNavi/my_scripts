...
if (!function_exists('add_styles')) { // если ф-я уже есть в дочерней теме - нам не надо её определять
	function add_styles() { // добавление стилей
	    if(is_admin()) return false; // если мы в админке - ничего не делаем
		wp_enqueue_style( 'main_reset', get_template_directory_uri().'/css/reset.css' ); 
		wp_enqueue_style( 'main_fonts', get_template_directory_uri().'/css/fonts.css' ); 
		wp_enqueue_style( 'main_style_wp', get_template_directory_uri().'/css/style_wp.css' ); 
		wp_enqueue_style( 'main', get_template_directory_uri().'/style.css' ); 
		wp_enqueue_style( 'main_media', get_template_directory_uri().'/css/media.css' ); 
	}
}
