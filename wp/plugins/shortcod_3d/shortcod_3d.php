...
// 1.2 сделал общий фон для текста при наведении на блок
// 1.3 исправлена ошибка, счета элементов в переменной, так как тип был строка, а не массив
// 1.4 добавил английский язык
