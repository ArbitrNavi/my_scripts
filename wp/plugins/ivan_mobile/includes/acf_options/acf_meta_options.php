<?php 			if( function_exists('acf_add_local_field_group') ):
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_62a1b09e125f5',
				'label' => 'Текст кнопки обратной связи',
				'name' => 'menu-header__popup_title',
				'type' => 'text',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_62a1b0bf125f6',
				'label' => 'Классы кнопки обратной связи',
				'name' => 'menu-header__popup_class',
				'type' => 'text',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
				...
				'default_value' => 'popmake-114',
				'placeholder' => 'popmake-114',
				'prepend' => '',
				'append' => '',
				'maxlength' => '',
			),
			array(
				...
				'label' => 'Показывать кнопку для отображение обратной связи',
				'name' => 'menu-header__popup',
				'type' => 'true_false',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_62a1b1a3eec2a',
				'label' => 'Цвет кнопки "Обратной связи"',
				'name' => 'menu-header__popup_bgcolor',
				'type' => 'color_picker',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_62a1915a159f1',
				'label' => 'Внешний отступ вверху',
				'name' => 'tb-table-mt',
				'type' => 'number',
				'instructions' => '',
				'required' => 0,
			...
			array(
				'key' => 'field_62a1917a159f2',
				'label' => 'Внешний отступ внизу',
				'name' => 'tb-table-mb',
				'type' => 'number',
				'instructions' => '',
				'required' => 0,
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			array(
				...
				'name' => 'p3d',
				'type' => 'repeater',
				'instructions' => 'Позволяет вставить миниатюры панорам в 2 колонки или на всю ширину с помощью шорткода [p3d ids="name_metka"] если указать width=100 то будет на всю ширину. Так же если указать ids=all выведутся все заданные панорамы.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
